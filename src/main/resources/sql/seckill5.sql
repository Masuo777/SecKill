...
-- Records of t_order
-- ----------------------------
INSERT INTO `t_order` VALUES (12, 15131297552, 1, 0, 'iphone 12 8+128', 1, 6299.00, 1, 0, '2022-03-14 15:10:03', NULL);
...
-- ----------------------------
INSERT INTO `t_seckill_goods` VALUES (1, 1, 6299.00, 19, '2022-03-12 10:54:00', '2022-03-20 10:54:00');
INSERT INTO `t_seckill_goods` VALUES (2, 2, 7299.00, 20, '2022-03-14 10:04:30', '2022-03-14 10:04:45');
...
-- ----------------------------
INSERT INTO `t_seckill_order` VALUES (3, 15131297552, 12, 1);
...
CREATE TABLE `t_user`  (
  ...
  `slat` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '加密yan',
